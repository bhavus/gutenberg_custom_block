				...
				if( products.length > 0) {
					...
					for ( let i = 0; i < products.length; i++ ) {
						...
						if ( products[i].images.length && typeof products[i].images[0] !== 'undefined' && products[i].images[0].src != '' ) {
							...
							img = creedally_pbw.woo_placeholder_image;
						}
			...
			function renderSearchResults() {
				...
				for ( let i = 0; i < products.length; i++ ) {
					...
					if ( products[i].images.length && typeof products[i].images[0].src !== 'undefined' && products[i].images[0].src != '' ) {
						...
						img = el('span', { key: 'gbt_18_carousel_search-img-wrapper', className: 'img-wrapper', dangerouslySetInnerHTML: { __html: '<span class="img" style="background-image: url(\''+creedally_pbw.woo_placeholder_image+'\')"></span>'}});
					}
					productElements.push(
						el(
							'span',
			...
			function renderSearchSelected() {
				...
				for ( let i = 0; i < products.length; i++ ) {
					...
					if ( products[i].images.length && typeof products[i].images[0].src !== 'undefined' && products[i].images[0].src != '' ) {
						...
						img = el('span', { key: 'gbt_18_carousel_search-selected-img-wrapper', className: 'img-wrapper', dangerouslySetInnerHTML: { __html: '<span class="img" style="background-image: url(\''+creedally_pbw.woo_placeholder_image+'\')"></span>'}});
					}
					productElements.push(
						el(
							'span',
